...
- [ ] 12.6 Content pass. Owner: **content-editor**. README (Discover, judgement persistence honesty, batch add, sign-up lists, reading copies), the cannot-be-imported line and "saved on this device" phrasing audited against the section 3 storage doctrine (no "safe" claims anywhere new), Plain English labels for every new control, Cyber Essentials wording check on the generator, house-style sweep (no em dashes, British English) across all new copy and comments.
