...
/* --- sitemap.xml (PRD section 18, amended by section 16's Phase 15 clause) --
   Lists /, /faq.html, /privacy.html, /contact.html and (once published)
   /how-we-choose.html. docs/how-we-choose.md exists but has not received
   Rocky's copy sign-off (BUILD-PLAN 14.3's conditional clause), so it ships
   without a sitemap entry until that sign-off lands; see TODO.md for the
   tracked gap. privacy.html and contact.html are hand-written static pages
   (BUILD-PLAN 15.1), not generated by this script; only their sitemap
   listing lives here. */
function buildSitemapXml() {
  const urls = [`${SITE_URL}/`, `${SITE_URL}/faq.html`, `${SITE_URL}/privacy.html`, `${SITE_URL}/contact.html`];
